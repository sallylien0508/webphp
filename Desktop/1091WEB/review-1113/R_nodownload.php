...
<div style="width:95%; margin-left:2.5%;">
    ...
    <h5 style="text-align:center; color:white; font-size:20px; letter-spacing:10px; text-indent:10px;">未下載檔案清單</h5>
    ...
    <table class="table table-hover">
        <thead style="background-color:tan;">
            <tr style="text-align:center;">
                ...
                <th style="text-align:left;"scope="col">標題</th>
                <th style="text-align:left;"scope="col">配稿日期</th>
                <th style="text-align:left;"scope="col">下載檔案</th>
            </tr>
        </thead>
