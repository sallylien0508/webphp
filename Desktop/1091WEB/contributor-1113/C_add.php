...
<div class="modal-body">
    <div style="width:95%; margin-left:2.5%;">
        <div class="table-responsive" style="margin-top:2%;">
            <h5 style="text-align:center; color:white; font-size:20px; letter-spacing:10px; text-indent:10px;">新增稿件</h5>
    ...
    <form>
        ...
        <textarea name = "content" cols="55" rows="4" maxlength="100"></textarea>
        </p> 
