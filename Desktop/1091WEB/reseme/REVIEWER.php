    ...
    <body id="page-top" class="body_img">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="sideNav" style="background: rgba(100, 85, 66);      ">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block" style="letter-spacing: 9px; text-indent: 9px; text-transform: uppercase; font-size: 27px;">reviewer</span>
            </a>
        ...
        <div class="container-fluid p-0" style="width: 80%;">
            ...
            switch($current_page){
                case 'download':
                    include 'R_downloadhomepage.php';
                    break;
                case 'reply':
                    include 'R_reply.php';
                    break;
