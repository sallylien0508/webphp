...
<html lang="en">
    ...
    <body id="page-top" class="body_img">
        <!-- Navigation-->
        <div class="nav_bg nav_img">
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="sideNav" style="background: rgba(100, 85, 66);">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">
                    <span class="d-block d-lg-none">Clarence Taylor</span>
                    <span class="d-none d-lg-block" style="letter-spacing: 9px; text-indent: 9px; text-transform: uppercase; font-size: 27px;">contributor</span>
                </a>
